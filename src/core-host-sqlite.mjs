...
export async function createCoreHostSqlite(root) {
  ...
  return createHostSqlite(root, { collectTableContract: collectSqliteTableContract, collectNamedIndexContract: collectSqliteNamedIndexContract, collectCanonicalStrictTables: collectCanonicalStrictTableMetadata });
}
