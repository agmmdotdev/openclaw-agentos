...
const loadCompactRuntime = createLazyRuntimeModule<typeof import("../agents/embedded-agent-runner/compact.runtime.js")>(
  () => { throw new Error("Unsupported core profile: gateway compaction runtime"); },
);
