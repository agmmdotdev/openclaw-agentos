...
// This embedded profile sets noExtensions; source loading is intentionally unavailable.
async function loadExtensionSourceTransformModule(
  _extensionPath: string,
  _context: ExtensionLoadContext,
): Promise<ExtensionFactory | undefined> {
  throw new Error("Unsupported core profile: source extension loader");
}
